var levelOne = {
    ...
    platforms: [{ x: 12,   y: 10.5,  size: 1, scale: 1, type: "Double", moving: true, direction: -1, speed: 50 },
                { x:  7.5, y: 10,    size: 1, scale: 1, type: "Double", moving: true, direction:  1, speed: 50 }, 
                { x:  5,   y: 10.5,  size: 1, scale: 1, type: "Double", moving: true, direction: -1, speed: 50 },
    ...
    frogs:    [{ x: 10, y: 0, scale: 3, color: "BlueBlue" },
               ...
               { x: 50, y: 0, scale: 3, color: "PurpleWhite" },
               { x: 55, y: 0, scale: 3, color: "BlueBlue" },
               { x: 45, y: 0, scale: 3, color: "GreenBrown" },
               ],

    cats:     [{ x: 57, y: 0, scale: 5, chosenOne: true}
               ],
};
