class Wolf {
    constructor(game, x, y, facing, state) {
        ...
        // spritesheet
        this.spritesheet = ASSET_MANAGER.getAsset("./wolf.png");

        // this.facing = 0; // 0 = left, 1 = right
        // this.state = 0; // 0 = idle, 1 = run, 2 = jump, 3 = attack, 4 = hurt, 5 = dead
    ...
    loadAnimations() {
        ...
        this.animations[0][0] = new Animator(this.spritesheet, 0,  0, 107, 75, 3, 0.1, 0, false, true, false);
        this.animations[0][1] = new Animator(this.spritesheet, 0, 80, 112, 75, 6, 0.1, 8, false, true, false);
